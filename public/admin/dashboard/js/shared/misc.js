    ...
    function appendBanner() {
        ...
        $("body").prepend('\
          <div class= "item-purchase-banner">\
            <p class="banner-text">Contact Phynia TastyBites Management for more inquiries           </p>\
              <a href="http://localhost/restaurant/public/index.php" target="_blank" class= "banner-button btn btn-primary btn-icon">\
                <i class="mdi mdi-cart"></i> Contact Manager\
              </a>\
